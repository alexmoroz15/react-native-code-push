...
using namespace winrt::CodePushDemoAppCpp2;
using namespace winrt::CodePushDemoAppCpp2::implementation;
...
void App::OnLaunched(activation::LaunchActivatedEventArgs const& e)
{
    ...
    rootFrame.Navigate(xaml_typename<CodePushDemoAppCpp2::MainPage>(), box_value(e.Arguments()));
}
